...
fisher_vectors_pkl = "pkl/leaves70.pkl"  # Arquivo pkl com os Fisher Vectors e rótulos
results_csv = "results/results_leaves.csv"  # Arquivo CSV para salvar os resultados
